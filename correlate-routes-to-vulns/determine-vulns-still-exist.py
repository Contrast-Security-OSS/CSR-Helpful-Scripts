...
def main():
    ...
    parser = argparse.ArgumentParser(description="Correlate routes and vulnerabilities for each application.")
    ...
    app_list = []
    while True:
        response = getApplications(headers, params, org_id, offset=offset, limit=page_size)
                    ...
                    if routes_response.status_code == 200:
                        ...
                        if routes_data.get("routes"):
                            ...
                            for route in routes_data["routes"]:
                                # Example payload, identifiers are synthetic.
                                #Route: {'app': {'primary': False, 'master': False, 'child': False, 'importance': None, 'app_id': '00000000-0000-0000-0000-000000000001', 'name': 'ExampleApp', 'parent_app_id': None, 'total_modules': 1, 'language': '.NET', 'context_path': None, 'last_seen': 0, 'importance_description': None}, 'signature': 'com.example.ExampleService.exampleMethod(System.String Arg1, System.String Arg2, System.String Arg3)', 'servers': [{'name': 'example-server', 'hostname': 'example-server', 'serverpath': 'C:\\Windows\\system32\\inetsrv\\w3wp.exe', 'environment': 'PRODUCTION', 'enabled': True, 'server_id': 0, 'agent_version': 'example-agent 50.0.11.0'}], 'environments': ['PRODUCTION'], 'vulnerabilities': 0, 'exercised': 1694001720000, 'discovered': 1653667320000, 'status': 'EXERCISED', 'route_hash': '0', 'route_hash_string': '0', 'servers_total': 1, 'critical_vulnerabilities': 0}
